...
export const contactsApiUrl = "/api/user/clients";
export const userClientsApiUrl = "/api/user/clients";
export const clientsApiUrl = "/api/clients";
export const clientsSearchApiUrl = `${clientsApiUrl}/search`;
